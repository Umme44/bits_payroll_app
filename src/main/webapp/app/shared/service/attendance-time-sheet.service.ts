...
export class AttendanceTimeSheetService {
  public resourceUrl = SERVER_API_URL + 'api/attendance-user/attendance-time-sheet';
  public resourceUrlForExportXL = SERVER_API_URL + 'api/attendance-user/export-attendance-time-sheet';
