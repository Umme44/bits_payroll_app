...
import { IEmployeeDashboardAnalytics } from '../../model/employee-dashboard-analytics.model';
...
export class EmployeeService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/employee-mgt/employees');
  public resourceUrlCommon = this.applicationConfigService.getEndpointFor('api/common/employees');
