...
type PfNomineeFormGroupContent = {
  ...
  pfAccount: FormControl<IPfNominee['pfAccount']>;
  pfWitness: FormControl<IPfNominee['pfWitness']>;
  approvedBy: FormControl<IPfNominee['approvedBy']>;
};
...
export class PfNomineeFormService {
  createPfNomineeFormGroup(pfNominee: PfNomineeFormGroupInput = { id: null }): PfNomineeFormGroup {
    ...
    return new FormGroup<PfNomineeFormGroupContent>({
      ...
      pfAccount: new FormControl(pfNomineeRawValue.pfAccount),
      pfWitness: new FormControl(pfNomineeRawValue.pfWitness),
      approvedBy: new FormControl(pfNomineeRawValue.approvedBy),
    });
  }
