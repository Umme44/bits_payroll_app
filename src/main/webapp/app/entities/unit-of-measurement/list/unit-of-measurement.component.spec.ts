...
describe('UnitOfMeasurement Management Component', () => {
  let comp: UnitOfMeasurementComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'unit-of-measurement', component: UnitOfMeasurementComponent }]),
      ...
      .overrideTemplate(UnitOfMeasurementComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.unitOfMeasurements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to unitOfMeasurementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUnitOfMeasurementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUnitOfMeasurementIdentifier).toHaveBeenCalledWith(entity);
