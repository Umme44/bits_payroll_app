...
describe('Holidays Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'holidays', component: HolidaysComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to holidaysService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHolidaysIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHolidaysIdentifier).toHaveBeenCalledWith(entity);
