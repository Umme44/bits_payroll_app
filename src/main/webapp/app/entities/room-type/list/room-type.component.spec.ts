...
describe('RoomType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'room-type', component: RoomTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.roomTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to roomTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRoomTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRoomTypeIdentifier).toHaveBeenCalledWith(entity);
