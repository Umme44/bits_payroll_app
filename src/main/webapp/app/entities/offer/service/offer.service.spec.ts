...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../offer.test-samples';

import { OfferService, RestOffer } from './offer.service';
