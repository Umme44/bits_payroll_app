...
describe('EducationDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'education-details', component: EducationDetailsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to educationDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEducationDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEducationDetailsIdentifier).toHaveBeenCalledWith(entity);
