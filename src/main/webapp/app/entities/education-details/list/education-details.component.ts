...
import { EducationDetailsService, EntityArrayResponseType } from '../service/education-details.service';
...
export class EducationDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEducationDetails): number => this.educationDetailsService.getEducationDetailsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.educationDetails = dataFromBody;
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.educationDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
