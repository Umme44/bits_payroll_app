...
export class ConfigService {
  ...
  protected resourceUrlProcurementOfficer = this.applicationConfigService.getEndpointFor('api/procurement-mgt/configs');
  protected resourceUrlCommon = this.applicationConfigService.getEndpointFor('api/common/configs/key');
  protected resourceUrlAllowanceName = this.applicationConfigService.getEndpointFor('api/employee-mgt/allowance-name');
