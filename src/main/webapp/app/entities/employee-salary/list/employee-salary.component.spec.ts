...
describe('EmployeeSalary Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'employee-salary', component: EmployeeSalaryComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeSalaries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeSalaryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeSalaryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeSalaryIdentifier).toHaveBeenCalledWith(entity);
