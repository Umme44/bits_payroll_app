...
describe('LeaveApplication routing resolve service', () => {
  ...
  let resultLeaveApplication: ILeaveApplication | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLeaveApplication).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILeaveApplication>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
