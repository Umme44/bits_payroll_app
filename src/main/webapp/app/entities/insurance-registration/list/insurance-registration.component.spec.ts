...
describe('InsuranceRegistration Management Component', () => {
  let comp: InsuranceRegistrationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'insurance-registration', component: InsuranceRegistrationComponent }]),
      ...
      .overrideTemplate(InsuranceRegistrationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.insuranceRegistrations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to insuranceRegistrationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInsuranceRegistrationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInsuranceRegistrationIdentifier).toHaveBeenCalledWith(entity);
