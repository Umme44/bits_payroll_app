...
import { EntityArrayResponseType, ReferencesService } from '../service/references.service';
...
export class ReferencesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IReferences): number => this.referencesService.getReferencesIdentifier(item);
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.referencesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
