...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../references.test-samples';

import { ReferencesService } from './references.service';

const requireRestSample: IReferences = {
...
describe('References Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a References', () => {
      ...
      const references = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(references).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a References', () => {
      const references = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(references).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addReferencesToCollectionIfMissing', () => {
      it('should add a References to an empty array', () => {
        const references: IReferences = sampleWithRequiredData;
      ...
      it("should add a References to an array that doesn't contain it", () => {
        const references: IReferences = sampleWithRequiredData;
        const referencesCollection: IReferences[] = [sampleWithPartialData];
        expectedResult = service.addReferencesToCollectionIfMissing(referencesCollection, references);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(references);
      });
      ...
      it('should add only unique References to an array', () => {
        const referencesArray: IReferences[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const referencesCollection: IReferences[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const references: IReferences = sampleWithRequiredData;
        const references2: IReferences = sampleWithPartialData;
    ...
    describe('compareReferences', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareReferences(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareReferences(entity1, entity2);
        const compareResult2 = service.compareReferences(entity2, entity1);
