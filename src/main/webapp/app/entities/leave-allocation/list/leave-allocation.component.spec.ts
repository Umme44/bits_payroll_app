...
describe('LeaveAllocation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'leave-allocation', component: LeaveAllocationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.leaveAllocations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to leaveAllocationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLeaveAllocationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLeaveAllocationIdentifier).toHaveBeenCalledWith(entity);
