...
describe('LeaveBalance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'leave-balance', component: LeaveBalanceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.leaveBalances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to leaveBalanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLeaveBalanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLeaveBalanceIdentifier).toHaveBeenCalledWith(entity);
