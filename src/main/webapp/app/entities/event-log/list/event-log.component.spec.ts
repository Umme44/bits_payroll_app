...
describe('EventLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'event-log', component: EventLogComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to eventLogService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEventLogIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEventLogIdentifier).toHaveBeenCalledWith(entity);
