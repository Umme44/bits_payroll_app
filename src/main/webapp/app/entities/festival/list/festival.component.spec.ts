...
describe('Festival Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'festival', component: FestivalComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.festivals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to festivalService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFestivalIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFestivalIdentifier).toHaveBeenCalledWith(entity);
