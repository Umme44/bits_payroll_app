...
type NomineeFormGroupContent = {
  ...
  employeeId: FormControl<INominee['employeeId']>;
  approvedById: FormControl<INominee['approvedById']>;
  witnessId: FormControl<INominee['witnessId']>;
  memberId: FormControl<INominee['memberId']>;
};
...
export class NomineeFormService {
  createNomineeFormGroup(nominee: NomineeFormGroupInput = { id: null }): NomineeFormGroup {
    ...
    return new FormGroup<NomineeFormGroupContent>({
      ...
      employeeId: new FormControl(nomineeRawValue.employeeId),
      approvedById: new FormControl(nomineeRawValue.approvedById),
      witnessId: new FormControl(nomineeRawValue.witnessId),
      memberId: new FormControl(nomineeRawValue.memberId),
    });
  }
