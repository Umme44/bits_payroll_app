...
describe('Band Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'band', component: BandComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bands?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to bandService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBandIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBandIdentifier).toHaveBeenCalledWith(entity);
