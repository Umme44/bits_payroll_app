...
describe('ItemInformation Management Component', () => {
  let comp: ItemInformationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'item-information', component: ItemInformationComponent }]),
      ...
      .overrideTemplate(ItemInformationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.itemInformations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to itemInformationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getItemInformationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getItemInformationIdentifier).toHaveBeenCalledWith(entity);
