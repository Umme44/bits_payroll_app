...
public class UserDTO {
    ...
    public UserDTO(@Email @Size(min = 5, max = 254) String login, String... authorities) {
        this.login = login;
        this.email = login + "@bracits.com";
        this.authorities = Stream.of(authorities).collect(Collectors.toSet());
        final String[] splitUsername = login.split("[.]");
        this.firstName = splitUsername[0];
        this.lastName = splitUsername[1];
        this.activated = true;
    }

    public UserDTO(String login, String name, String email, String imageUrl, boolean activated, String... authorities) {
        this.login = login;
