...
public class RoomRequisitionResource {
    ...
    public RoomRequisitionResource(RoomRequisitionService roomRequisitionService, CurrentEmployeeService currentEmployeeService) {
    ...
    @GetMapping("/room-requisitions/status/{requesterId}/{status}")
    public ResponseEntity<List<RoomRequisitionDTO>> getRoomRequisitionByIdAndStatus(
        @PathVariable(required = false) Long requesterId,
        @PathVariable String status
    ) {
        List<RoomRequisitionDTO> roomRequisitionDTOList = roomRequisitionService.getRoomRequisitionByIdAndStatus(requesterId, status);
        return ResponseEntity.ok(roomRequisitionDTOList);
    }

    @GetMapping("/room-requisitions/all-requester-list")
    public ResponseEntity<List<EmployeeMinimalDTO>> getAllRoomRequester() {
        List<EmployeeMinimalDTO> roomRequesterList = roomRequisitionService.getAllRoomRequester();
        return ResponseEntity.ok(roomRequesterList);
    }

    @GetMapping("/room-requisitions/status/{requesterId}")
    public ResponseEntity<List<RoomRequisitionDTO>> getRoomRequisitionByUserId(@PathVariable Long requesterId) {
        List<RoomRequisitionDTO> roomRequisitionDTOList = roomRequisitionService.getRoomRequisitionByUserIdAndStatus(requesterId);
        return ResponseEntity.ok(roomRequisitionDTOList);
    }
}
