...
public class PromotionResource {
    ...
    private static final String RESOURCE_NAME = "PromotionResource";
    ...
    public PromotionResource(
        ...
        @Qualifier("Promotions") BatchOperationsViaXlsx batchOperationsViaXlsx,
    ...
    public ResponseEntity<EmploymentHistoryDTO> createEmploymentHistory(@RequestBody EmploymentHistoryDTO employmentHistoryDTO)
        ...
        EmploymentHistoryDTO result = promotionService.createPromotion(employmentHistoryDTO);
    ...
    public ResponseEntity<EmploymentHistoryDTO> updateEmploymentHistory(@RequestBody EmploymentHistoryDTO employmentHistoryDTO)
        ...
        EmploymentHistoryDTO result = promotionService.updatePromotion(employmentHistoryDTO);
    ...
    public ResponseEntity<Void> deleteEmploymentHistory(@PathVariable Long id) {
        ...
        EmploymentHistoryDTO employmentHistoryDTO = promotionService.deletePromotion(id);
        User user = currentEmployeeService.getCurrentUser().get();
    ...
    public ResponseEntity<List<EmploymentHistoryDTO>> getAllPromotions(
        ...
        Page<EmploymentHistoryDTO> page = employmentHistoryService.findAll(EventType.PROMOTION, employeeId, startDate, endDate, pageable);
